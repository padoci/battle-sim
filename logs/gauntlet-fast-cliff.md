...
25 runs/mode · player search = **fast** · draft = **greedy** · easy ramp = **cliff** · 560s total.
...
|---|---|---|---|
| easy | **4%** (1/25) | 100% · 100% · 100% · 36% · 12% · 4% | 3.5 |
| normal | **0%** (0/25) | 100% · 52% · 12% · 0% · 0% · 0% | 1.6 |

## Per-rung win rate (of runs that reached it)

| mode | rung1 | rung2 | rung3 | rung4 | rung5 | rung6 |
|---|---|---|---|---|---|---|
| easy | 100% (25/25) | 100% (25/25) | 36% (9/25) | 33% (3/9) | 33% (1/3) | 100% (1/1) |
| normal | 52% (13/25) | 23% (3/13) | 0% (0/3) | — | — | — |
...
|---|---|---|---|---|---|---|---|
| easy | 0 | 0 | 16 | 6 | 2 | 0 | 1 |
| normal | 12 | 10 | 3 | 0 | 0 | 0 | 0 |

## Tera timing (player, p1)

| mode | Tera'd in | mean Tera turn | mean % through battle |
|---|---|---|---|
| easy | 98% of battles (86/88) | turn 3.8 | 16% |
| normal | 100% of battles (41/41) | turn 5.5 | 14% |

mean turns/battle: easy 29 · normal 40
